...
function submit_trap() {
	...
	var hd=[{lb:"Action",ft:"sel",fn:"bs_axn"},{lb:"Remarks",fn:"bsremarks"}]
...
function load_traps(rst) {
	var traps=rst.traps;
	adata.traps=traps
	var hd=[{lb:"Name",fn:"name"},{lb:"Travel Type",fn:"travel_type"},{lb:"Application Date",fn:"app_date"},{lb:"Destination",fn:"destination"},{lb:"Start Date",fn:"leave_start"},{lb:"End Date",fn:"leave_end"},{lb:"Sponsorship",fn:"sponsorship"},{lb:"Purpose",fn:"purpose"},{lb:"Status",fn:"status"},{lb:"",ft:"btn",text:"View",oc:"view_trap"}]
